...
public class ModifierEntrant extends javax.swing.JFrame {
            ...
            if (rs.next()) {
                ...
                origine.addActionListener(new ActionListener() {
                    ...
                    public void actionPerformed(ActionEvent e) {
                        if ("CISCO Manandriana".equals(origine.getSelectedItem()) || "SISCO fandriana".equals(origine.getSelectedItem()) || "CISCO Ambatofinandrahana".equals(origine.getSelectedItem()) || "CISCO Ambositra".equals(origine.getSelectedItem())) {
    ...
    private void initComponents() {
        ...
        setUndecorated(true);
        setPreferredSize(new java.awt.Dimension(618, 507));
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ModifierEntrant().setVisible(true);
            }
        });
    }
